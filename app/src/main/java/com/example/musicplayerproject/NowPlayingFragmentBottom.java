...
import static com.example.musicplayerproject.MainActivity.ARTIST_TO_FRAG;
import static com.example.musicplayerproject.MainActivity.PATH_TO_FRAG;
import static com.example.musicplayerproject.MainActivity.SHOW_MINI_PLAYER;
import static com.example.musicplayerproject.MainActivity.SONG_NAME_TO_FRAG;
                            ...
                            if(SHOW_MINI_PLAYER){
                                if(PATH_TO_FRAG != null){
                                    ...
                                    if (art != null){
                                        ...
                                        Glide.with(getContext()).load(R.drawable.music_logo).into(albumArt);
                                    }
